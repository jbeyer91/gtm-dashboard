...
def get_all_open_deals(start: datetime = None, end: datetime = None) -> list:
    ...
    payload = {
        ...
        "properties": [
            ...
            "hs_date_entered_1294419353",
            "hs_date_entered_71300359",
...
def get_tam_funnel_counts(team: str = "all") -> dict:
    ...
    # prime and prime_stale totals are summed from per-rep breakdown in the
    # frontend JS so there is no circular blocking call here.
    workers = [
